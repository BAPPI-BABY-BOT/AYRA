...
(event.body.toLowerCase() == "Bot love u")) {
     return api.sendMessage("বস 𝐁𝐀𝐏𝐏𝐈 মেয়েদে'র সাথে কথা বলতে মানা করছে-🙂🤗🐸", threadID);
   };

    if ((event.body.toLowerCase() == "bot jamay dau") || (event.body.toLowerCase() == "Bot jamay dau") ||
(event.body.toLowerCase() == "বট জামাই দাও")) {
     return api.sendMessage("আমার বস বাপ্পি কে চোখে দেখো না নাকি__😒🥱", threadID);
   };
   
    if ((event.body.toLowerCase() == "I love you bot") || (event.body.toLowerCase() == "Bot i love you")) {
     return api.sendMessage("আমাকে না আমার বস 𝐁𝐀𝐏𝐏𝐈 কে ভালোবাসো-😻🤗🌺", threadID);
   };
...
(event.body.toLowerCase() == "Chup thak")) {
     return api.sendMessage("-না আমি চুপ থাকবো না-😼-বস 𝐁𝐀𝐏𝐏𝐈 আমারে কথা বলতে বলছে-🥱🥷", threadID);
   };

   if ((event.body.toLowerCase() == "চুম্মাহ দাও") || (event.body.toLowerCase() == "kiss me")) {
     return api.sendMessage("️-আমি দিবো না-😏-বস 𝐁𝐀𝐏𝐏𝐈 কে বলো চু'মু দিতে-🫣🐸", threadID);
   };
  
   if ((event.body.toLowerCase() == "bot ar bacca") || (event.body.toLowerCase() == "বট এর বাচ্ছা") ||
      (event.body.toLowerCase() == "Bot er bacca")) {
     return api.sendMessage("উফফ-🥵-ঝাং-🤤-আমার বস 𝐁𝐀𝐏𝐏𝐈 এর বাচ্ছা তো তোমার পেটে-🥱💦", threadID);
   };
...
(event.body.toLowerCase() == "Bow ki")) {
   ...
   if ((event.body.toLowerCase() == "তোর বানাইছে কে") || (event.body.toLowerCase() == "এটা কার বট")) {
     return api.sendMessage("️আমার বস 𝐁𝐀𝐏𝐏𝐈 আমাকে শুধুমাত্র আপনাদের কে বিনোদনের জন্য তৈরি করেছেন__😊😌", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "MISS YOU") || (event.body.toLowerCase() == "miss you")) {
     return api.sendMessage("<আমি তোমাকে রাইতে মিস খাই🥹🤖👅/👅-✘ 𝐁𝐀𝐏𝐏𝐈 🎀 🍒:))", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "বাপ্পি") || (event.body.toLowerCase() == "BAPPI") || (event.body.toLowerCase() == "bappi") || (event.body.toLowerCase() == "Bappi")) {
     return api.sendMessage("👉আমার বস♻️ 𝐁𝐀𝐏𝐏𝐈 এখন বিজি আছে । তার ইনবক্সে এ মেসেজ দিয়ে রাখো ‎‎‎‎‎‎‎‎‎https://www.facebook.com/share/1Bv6wJP4gv/?mibextid=qi2Omg/🔰                                        ♪√বস ফ্রি হলে আসবে 🧡😁😜🐒",threadID);

       
   };

   if ((event.body.toLowerCase() == "/owner") || (event.body.toLowerCase() == "/Owner")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞𝐌𝐑.𝐁𝐎𝐒𝐒 𝐁𝐀𝐏𝐏𝐈☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐁𝐀𝐏𝐏𝐈.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤-https://www.facebook.com/share/1Bv6wJP4gv/?mibextid=qi2Omgতার সাতে যোগা যোগ করবেন WhatsApp :- 01725973997", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke")) {
     return api.sendMessage("My Creator:𝐁𝐀𝐏𝐏𝐈 ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস 𝐁𝐀𝐏𝐏𝐈 আমাকে আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য/n আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is 𝙼𝚁.𝙱𝙾𝚂𝚂 𝐁𝐀𝐏𝐏𝐈 ❤️/n তাকে সবাই 𝐁𝐀𝐏𝐏𝐈 নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "neha") || (event.body.toLowerCase() == "NEHA")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস 𝐁𝐀𝐏𝐏𝐈 এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Nahid") || (event.body.toLowerCase() == "nahid")) {
     return api.sendMessage("🥰-নাহিদ-🌺 আমার বস 𝐁𝐀𝐏𝐏𝐈 এর কলিজার বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name ki") || (event.body.toLowerCase() == "name ki") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>👅-𝙼𝚁.𝙱𝙾𝚂𝚂 𝐁𝐀𝐏𝐏𝐈🎀 🍒", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("হুম আমার বস 𝐁𝐀𝐏𝐏𝐈 ও তেমাকে ভালোবাসে🥰🥱", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami tor boss") || (event.body.toLowerCase() == "Ami tor boss")) {
     return api.sendMessage("হ্যা 𝐁𝐀𝐏𝐏𝐈 স্যার কেমন আছেন..?☺️", threadID);
   };
  
   if ((event.body.toLowerCase() == "Bye") || (event.body.toLowerCase() == "bye")) {
     return api.sendMessage("️বাই তো বললে সোজা অফলাইনে যাও অন্য কারো ইনবক্সে যেও না গেলে আমার বস্ _𝐁𝐀𝐏𝐏𝐈 এর_ ইনবক্সে যাও", threadID);
   };
